      ...
      >
        ...
        <div className="overflow-y-auto flex-1 p-6 sm:p-8 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-5 items-center sm:items-start text-center sm:text-left pb-6 border-b border-slate-100">
            ...
            <div className="space-y-2 flex-1">
              <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2">
                <h2 className="text-xl font-extrabold text-slate-900 leading-tight">{tutor.name}</h2>
              ...
              <div className="flex items-center justify-center sm:justify-start gap-2 text-slate-600 text-xs">
                ...
                <span className="font-semibold">{details.qualification}</span>
              </div>
          ...
          <div className="space-y-3">
            ...
            {details.expertiseAreas && details.expertiseAreas.length > 0 && (
              <div>
                ...
                <div className="flex flex-wrap gap-1.5">
                  {details.expertiseAreas.map((exp, eIdx) => (
                    <span 
                      key={eIdx} 
          ...
          {((details.workingHours && details.workingHours.length > 0) || (details.daysOff && details.daysOff.length > 0)) && (
