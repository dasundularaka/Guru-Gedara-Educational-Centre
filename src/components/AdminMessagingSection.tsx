        ...
        <div className="flex items-center gap-2">
          ...
          {onClose && (
            <button
              type="button"
              onClick={onClose}
              className="px-3 py-2 rounded-xl bg-rose-600 hover:bg-rose-500 text-white font-bold text-xs flex items-center gap-1.5 transition-all shadow-sm cursor-pointer min-h-[38px]"
              title="Close messaging hub and return to dashboard"
              id="btn_close_admin_messaging_section"
            >
              <X className="w-4 h-4" />
            ...
            <>
              ...
              <div className="p-3 sm:p-3.5 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between gap-3 bg-slate-50/60 dark:bg-slate-900/60 shrink-0">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  {/* Close conversation and exit to dashboard */}
                  {onClose && (
                    <button
                      type="button"
                      onClick={onClose}
                      className="py-1.5 px-2 sm:px-2.5 rounded-xl bg-slate-100 hover:bg-rose-50 dark:bg-slate-800 dark:hover:bg-rose-950/50 text-slate-600 hover:text-rose-600 dark:text-slate-300 dark:hover:text-rose-400 border border-slate-200 dark:border-slate-700 text-xs font-bold flex items-center gap-1 transition-colors cursor-pointer shrink-0"
                      title="Close messaging hub and return to dashboard"
                      id="btn_close_active_conversation"
                    >
                      <X className="w-3.5 h-3.5" />
