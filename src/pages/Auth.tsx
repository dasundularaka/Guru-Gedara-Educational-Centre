...
export const Auth: React.FC<AuthProps> = ({ onAuthSuccess }) => {
  const { loginWithGoogle, loginWithEmail, registerWithEmail, classes, refreshClasses, showToast } = useApp();
          ...
          <form onSubmit={handlePasswordChangeSubmit} className="space-y-4">
            <div>
              <p className="text-[11px] text-slate-500 mb-4 bg-blue-50/50 p-3 rounded-xl border border-blue-100 leading-normal">
                Forgot or need to change your passcode? Provide your registered email and assign a new password instantly. Valid for all account types.
              </p>
